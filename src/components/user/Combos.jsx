...
/* Same 2-per-view mobile slider pattern used across the site */
        ...
        {products.map((_, i) => (
          <button
            ...
            style={{
              ...
              height:     10,
              background: i === activeIdx ? '#B5EDDB' : '#F8A5B5',
            }}
...
export default function Combos() {
  ...
  useEffect(() => {
    /*
      Fetch products filtered by category "combo" (case-insensitive match).
      The backend accepts ?category=combo which filters by the category field.
    */
    fetch(`${BASE}product?category=combo&limit=8`, { cache: 'no-store' })
      .then(r => r.json())
  ...
  /* Hide section gracefully if no combo products exist */
  ...
  return (
    ...
    >
      {/* Mint-tinted overlay for distinct feel from Best Sellers (which uses white) */}
      <div className="absolute inset-0 pointer-events-none"
           style={{ background: 'rgba(240,255,250,0.92)' }} aria-hidden="true" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="w-16 h-0.5 rounded-full mb-8"
             style={{ background: 'linear-gradient(to right,#B5EDDB,#E05C88)' }} />
        ...
        {loading ? (
          ...
          <>
            {/* Mobile: 2-per-view swipe slider */}
            <div className="md:hidden">
